...
const Projects = () => {
  // For simplicity, we'll use the initialProjects directly and remove admin/filtering logic
  // for this new full-screen layout.
  const projects = initialProjects.filter(p => p.featured);
